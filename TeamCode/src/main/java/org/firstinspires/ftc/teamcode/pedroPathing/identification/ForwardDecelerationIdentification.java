 ...
 */
@TeleOp(name = "Forward Deceleration Identification", group = "2")
public class ForwardDecelerationIdentification extends OpMode {
    ...
    public void init_loop() {
        telemetry.addLine("Group 2: free forward decel → maxAchievableForwardDeceleration.");
        telemetry.addLine("Accelerates to " + VELOCITY + " in/s, cuts power, measures coast deceleration.");
